import { EMPTY, NextObserver, Observable, Subject, Subscribable, Subscription } from 'rxjs';
...
export function createCdAware<U>(cfg: {
	...
	const potentialObservablesSubject = new Subject<Observable<U> | undefined | null>();
