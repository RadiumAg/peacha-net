import { Component, OnInit, Directive, Renderer2, ElementRef, HostListener } from '@angular/core';
...
export class ImageShadowDirective implements OnInit {
	...
	hover(e: Event) {
		this.re2.setStyle(this.el.nativeElement, 'box-shadow', ' 0px 0px 16px 0 rgba(0, 0, 0, 0.08)');
	}
