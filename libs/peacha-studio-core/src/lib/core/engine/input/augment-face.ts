...
export const PLATFORM_FT_DEVICE_ENUMERATE = new InjectionToken<EnumerateDeviceFunciton>(
  'platform face track device enum'
);

export const PLATFORM_FT_FACTORY = new InjectionToken<PlatformTrackerFactory>(
  'platform tracker factory'
);
