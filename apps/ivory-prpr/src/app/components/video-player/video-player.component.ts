...
@Component({
    ...
    template: `<a (click)="close()"></a
        ><video [src]="videoSrc" controls="controls" width="1280" height="720" autoplay></video>`,
    styleUrls: ['./video-player.component.less'],
})
export class VideoPlayerComponent implements OnInit {
    videoSrc = '';
    constructor(
        @Inject(MODAL_DATA_TOKEN) data: { src: string },
        private modal: ModalRef<string>
    ) {
