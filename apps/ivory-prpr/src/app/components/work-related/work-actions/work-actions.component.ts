    ...
    animations: [
        trigger('like', [
            ...
            transition('0 => 1',
                [
                    group([
                        query('span',animate('1000ms', keyframes([
                            style({ offset:0}),
                        ...
                        query('img',animate('1000ms', keyframes([
                            style({ offset:0}),
...
export class WorkActionsComponent {
    ...
    private _isLike: string;
    @Input('isLike')
    public get isLike(): string {
        return this._isLike;
    }
    public set isLike(v: string) {
        this._isLike = v;
        if (v) {
            this.likeOffset = 1;
        }
