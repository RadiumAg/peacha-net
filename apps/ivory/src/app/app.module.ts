...
const routes: Routes = [
  {
    ...
    loadChildren: () =>
      import('./pages/commission/commission.module').then(
        (x) => x.CommissionModule
      ),
  },
  {
    path: 'release',
    loadChildren: () =>
      import('./pages/release/release.module').then((x) => x.ReleaseModule),
  ...
  },
  {
    path: 'edit',
    loadChildren: () =>
      import('./pages/release/edit.module').then((m) => m.EditModule),
  },
  {
    path: 'passport',
    loadChildren: () =>
  ...
  },
  {
    path: 'live2d',
    loadChildren: () =>
      import('./pages/work-live2d/work-live2d.module').then(
        (m) => m.WorkLive2dModule
      ),
  },
  {
    path: 'pay',
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/creater-certification/creater-certification.module').then(
        (m) => m.CreaterCertificationModule
      ),
    canActivate: [PhoneGuard],
  },
  {
