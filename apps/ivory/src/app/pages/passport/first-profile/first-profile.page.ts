...
export class FirstProfilePage {
	...
	constructor(private fb: FormBuilder, private store: Store, private route: ActivatedRoute, private router: Router) {
		this.detailsForm = this.fb.group({
			...
			nickname: new FormControl('', [Validators.maxLength(20), Validators.minLength(2), this.myPattern]),
	...
	get isDisabled() {
		return !this.detailsForm.touched ? 'disabled' : this.detailsForm.valid ? null : 'disabled';
	}
