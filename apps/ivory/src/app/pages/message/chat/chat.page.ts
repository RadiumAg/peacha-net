...
export class ChatPage implements OnInit, OnDestroy {
  ...
  isButtom$ = combineLatest([
    this.dialog.isButtom$,
  ...
  getMoreList(event: Event): void {
    ...
    if (
      this.showbox.nativeElement.scrollTop +
        this.showbox.nativeElement.clientHeight ==
      this.showbox.nativeElement.scrollHeight
    ) {
      this.dialog.getList();
    }
  }
